...
const CACHE = 'tm-pelaaja-v19';   // i18n V4-A3-taydennys — kotinaytto 100% sv (streak/signaali/fiilis/Bola Siempre) + Osa B seura.kieli (harjoitelogiikka ?v=12, tm_lang ?v=5) (§27.4)
