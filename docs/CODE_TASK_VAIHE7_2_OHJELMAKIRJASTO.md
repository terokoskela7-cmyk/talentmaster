...
- **Näkymä:** kirjaston ohjelmakortti → "ajettu **N** pelaajalla · ka delta **X** · toteuma **Y %** · tulos-jakauma (parani/ennallaan/vaihda)". Fysiikkavalmentaja näkee **�ikä ohjelma toimii kenelle** (ikä/PHV-vaihe-erittely).
...
- **Kuormaevidenssi (kun K5 tulee):** `kuorma_kooste` (GPS/Catapult, §7-tulevaisuus) lisättävissä koosteeseen additiivisesti — dose ≠ response (kuorma täydentää toteutumaa, ei korvaa deltaa).
