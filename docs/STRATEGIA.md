...
4. **Varhainen tekniikkamitali = longitudinaalinen vahvistus.** Korkea D2 *tänään* on poikkileikkaustieto. Mutta tekniikkakilpailun **kulta/hopea U8–U12** on todiste että tekninen ohjelma rakentui plastisimmassa ikkunassa → **motorinen automatisaatio**: toistettu taito siirtyy tietoisesta kontrollista alitajunnan suoritukseksi (vrt. kokenut autonkuljettaja). Automatisoitunut tekniikka U12-ikään mennessä vapauttaa kognitiivisen kapasiteetin pelitilanteessa havainnointiin ja ennakointiin sen sijaan että se kuluisi pallonhallintaan → **D4/ADAR korreloi varhaisen teknisen automatisaation kanssa, ei pelkän kronologisen iän.** Pelaaja jolla on 10-v mitalitaso ei ole vain "taitava" — hän on rakentanut kapasiteettia joka tuottaa pelikäyttöön 3–5 v myöhemmin kun taktinen kompleksisuus kasvaa. **Eri luokan Hidden Gem** kuin korkea D2 ilman historiallista evidenssiä (joka voi olla myöhäiskehitystä tai yksittäinen hyvä testipäivä).
