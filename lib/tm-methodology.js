...
(function(root) {
  ...
  // ═══════════════════════════════════════════════════════════════════
  var MESOSYKLIT = {
    9:  { kk: 'Syyskuu',   teema: 'Maestro',      alue: 'Vastaanottaminen',   kuvaus: 'Ensimmäinen kosketus ratkaisee' },
    10: { kk: 'Lokakuu',   teema: 'Shadowstep',   alue: 'Dribbelin perusta',  kuvaus: 'Katse ylös, neljä perustaitoa' },
    11: { kk: 'Marraskuu', teema: 'Shadowstep',   alue: '1v1-liikkeet',       kuvaus: 'U-käännös, saksi, vetokäännös' },
    12: { kk: 'Joulukuu',  teema: 'Maestro',      alue: 'Syöttäminen',        kuvaus: 'Sisäterä, jalkapöytä, pitkä passi' },
    1:  { kk: 'Tammikuu',  teema: 'Maestro II',    alue: 'Vastaanottaminen (vaativa)', kuvaus: 'Kierros 2 — paineessa' },
    2:  { kk: 'Helmikuu',  teema: 'Shadowstep II', alue: 'Dribbeli (vastustaja)', kuvaus: 'Aktiivinen puolustaja' },
    3:  { kk: 'Maaliskuu', teema: 'Shadowstep II', alue: '1v1 pelissä',      kuvaus: 'Pieni alue, feintit' },
    4:  { kk: 'Huhtikuu',  teema: 'Maestro II',    alue: 'Syöttö pelissä',   kuvaus: 'Läpisyötöt, vapaat potkut' },
