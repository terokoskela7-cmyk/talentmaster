...
(function(root) {
  ...
  // Mappaa idoli → PANKKI:n T-mesosykli/kohde + liikeketjut (D/S). PANKKI +
  ...
  var TEEMA_PANKKI = {
    ...
    kane:       { t: null, ketjut: ['sfl'], placeholder: 'Kane / maalinteko — sisältö lisätään Vaiheessa 2' }, // vk7
  ...
  function haePaatreeniHarjoite(viikkoTeema, deps, profiili) {
    ...
    // OMA-viikko: jos pelaaja on valinnut idolin, käytä sitä; muuten OMA → perus (vapaa pallokosketus).
