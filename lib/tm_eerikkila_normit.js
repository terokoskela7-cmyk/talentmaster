...
const HH_TESTI_MAP = {
  ...
  mas:      { eerikkila: 'mas',        yksikko: 'km/h', pienempi: false, phvHerkka: false, kmh: true },
  kasirata: { eerikkila: 'kasirata',   yksikko: 's',    pienempi: true,  phvHerkka: true },
  sm_pallo: { eerikkila: 'sm_pallo',   yksikko: 's',    pienempi: true,  phvHerkka: false },  // tekniikka → AINA sallittu
};
