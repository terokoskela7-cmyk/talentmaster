...
// Palauttaa {tyyppi:'hh'|'tk', akselit:[{kentta,key,raakaKa,n}]} | null kun <3 akselia (collapse, kuten 5D-radar).
...
var _RADAR_TK_AKSELIT = [
  { kentta: 'ponnauttelu', key: 'Ponn.' }, { kentta: 'syotto', key: 'Syöttö' }, { kentta: 'pujottelu', key: 'Pujottelu' },
  { kentta: 'kuljetus_laukaus', key: 'Kulj-lauk.' }, { kentta: 'pituuspotku', key: 'Pit.potku' }
];
function tavoiteRadarAkselit(pelaajat) {
  ...
  kand.forEach(function (a) {
    ...
    if (c > 0) akselit.push({ kentta: a.kentta, key: a.key, raakaKa: Math.round(s / c * 100) / 100, n: c });
  });
