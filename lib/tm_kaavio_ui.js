...
function _kaavioXtHTML() {
  ...
  h += '<div style="display:flex;gap:6px;flex-wrap:wrap;margin-bottom:6px">' + nappi(null, 'Pois') + nappi('arvot', 'Liikkeiden arvot') + nappi('kartta', 'Uhkakartta') + '</div>';
...
function _kaavioPiirraEditori() {
  ...
  if (_kaavioTila.xt && typeof xtPiirraKerros === 'function') {
    _kaavioTila.xtAnalyysi = xtPiirraKerros(svg, _kaavioTila.muokkaus.spec, { uhkakartta: _kaavioTila.xt !== 'arvot', arvot: true });
  }
