...
// Pikakentät pelaajadokkiin (§26): idp_tila · idp_edistyma · idp_fokus · idp_viim_review.
function idpPikakentat(tavoite) {
  if (!tavoite) return { idp_tila: null, idp_edistyma: null, idp_fokus: null, idp_viim_review: null };
