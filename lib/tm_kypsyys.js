/* tm_kypsyys.js — Kypsyys / PHV -komponentti (jaettu renderöijä). Korvaa paljaan "AN"-koodin luettavalla
   ...
   pistettä; PH-tila → kuormarajoitin (§28); tyhjä (ei kypsyysdataa) = rehellinen tyhjä tila.
   TODO (VAIHE 2): opts.rooli varattu — pelaajavariantti (§7.22) joka pehmentää §28-seliterivit ei vielä
   toteutettu; nykyversio on VP/valmentaja-facing (aikuisnäkymä). Älä lupaa §7.22:ta ennen toteutusta. */
(function (root) {
  'use strict';
