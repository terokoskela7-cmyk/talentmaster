...
function drawSpec(s,lang){
  ...
  s.pelaajat.forEach(p=>{const nk=nakokenttaOf(p,s); if(!nk) return;
    ...
    if(nk.katve){const kh=Math.max(0,180-nk.half);
      if(kh>0) g.append(el("path",{d:sector(px,py,dir+180,kh,cr*0.9),fill:"var(--red)","fill-opacity":.09,stroke:"var(--red)","stroke-width":.8,"stroke-dasharray":"2 4","stroke-opacity":.35,"stroke-linejoin":"round"}));}
