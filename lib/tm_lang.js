...
const TM_LANG = {
  ...
  // ── SUOMI (referenssikieli) ────────────────────────────────────
    ...
    mittarit: {
      ...
      // §7.22 — pelaajalle EI lukua vaan tila. Kynnykset 70/40 = samat kuin värikoodaus.
      valmiustila_valmis:   'Valmis treenaamaan',
      valmiustila_kehittyy: 'Kehittyy',
      valmiustila_huolto:   'Tarvitsee huoltoa',
      valmiustila_ei_dataa: 'Ei mitattu vielä',
    },

    // Kortti-välilehti (§7.22 + §58: aggregaatti-OVR vain Showcaselle, muille laadullinen tila)
    kortti: {
      otsikko:       'Kortti',
      tilastot:      'TILASTOT',
      streak:        'Streak',
      pv:            'pv',
      osa_aluetta:   'osa-aluetta',
      kasvaa:        'Kortti kasvaa kehittymisesi mukana.',
      seuraava_taso: 'Seuraava taso',
    },

    // Kaavio (erä D1) — hyväksytty teknis-taktinen piirros pelaajan konseptikortilla (§7.22)
    kaavio: {
      otsikko: 'Miltä se näyttää kentällä',
      saate:   'Valmentajasi piirsi tämän sinua varten.',
      kuittaa: 'Ymmärsin tämän',
      kuitattu: 'Ymmärretty',
      kuittaus_epaonnistui: 'Kuittaus ei mennyt perille — yritä hetken päästä.',
    },

    // Konseptikortti (Vaihe 4b) — CHROME. Sisältö tulee curriculum-kaanonista (sv-sidecar; ei en-lähdettä).
    konseptikortti: {
      eyebrow:           'Minä ja pallo · tämän hetken fokus',
      milloin_nakyy:     'Milloin tämä näkyy',
      miksi_auttaa:      'Miksi se auttaa',
      mieti_pelissa:     'Mieti tätä pelissä',
      kokeile:           'Kokeile tätä',
      valmentaja_katsoo: 'Valmentajasi katsoo samaa juttua.',
      vaihe_leikkija:    'Leikkijän vaihe',
      vaihe_rakentaja:   'Rakentajan vaihe',
      vaihe_pelipaikka:  'Pelipaikan vaihe',
    },
    ...
    vanhempi: {
      kortti_matka_otsikko: '{gen} matka',
      huoltaja_otsikko: '{gen} huoltaja',
      toast_treeni_kirjattu: 'Treeni kirjattu',
      toast_pallo_ok: ' · pallo ✓',
      toast_kehu_lahetetty: 'Kehu lähetetty!',
      toast_kopioi_pin: 'Kopioi PIN manuaalisesti',
      toast_kirjauduttu_ulos: 'Kirjauduttu ulos',
      toast_valmentaja_reagoi: 'Valmentaja {emoji} reagoi',
      toast_kirjasi_treenin: '{nimi} kirjasi treenin',
      mark_luetuiksi: 'Merkitse luetuiksi',
      tulevat_tapahtumat: 'Tulevat tapahtumat',
      vinkki_otsikko_u12: 'Vinkki vanhemmille',
      vinkki_otsikko_u15: 'Muistathan',
      vinkki_otsikko_rooli: 'Roolisi',
      tek_miten_tukea: 'Miten tukea kotona',
      kortti_jaa_otsikko: 'Jaa kortti',
      kortti_jaa_nappi: 'JAA',
      aset_yksityisyys: 'Yksityisyys',
      aset_hallitsee_dataa: '{nimi} hallitsee dataa',
      aset_lue_gdpr: 'Lue GDPR-selvitys',
      aset_kirjaudu_ulos: 'Kirjaudu ulos',
      tyyppi_treeni: 'treeni',
      tapahtuma_nimeton: 'Tapahtuma',
      hero_tervetuloa_app:    '{nimi} — tervetuloa TalentMasteriin',
  ...
  sv: {
    ...
    mittarit: {
      ...
      valmiustila_valmis:   'Redo att träna',
      valmiustila_kehittyy: 'Utvecklas',
      valmiustila_huolto:   'Behöver omvårdnad',
      valmiustila_ei_dataa: 'Inte mätt ännu',
    },
    ...
    kortti: {
      ...
      streak:        'Streak',
      pv:            'd',
      osa_aluetta:   'delområden',
      kasvaa:        'Kortet växer med din utveckling.',
      seuraava_taso: 'Nästa nivå',
    },

    // Diagram (etapp D1)
    kaavio: {
      otsikko: 'Så här ser det ut på planen',
      saate:   'Din tränare ritade det här för dig.',
      kuittaa: 'Jag förstod det här',
      kuitattu: 'Förstått',
      kuittaus_epaonnistui: 'Kvitteringen gick inte fram — försök om en stund.',
    },

    // Konceptkortet (etapp 4b) — chrome.
    konseptikortti: {
      eyebrow:           'Jag och bollen · fokus just nu',
      milloin_nakyy:     'När syns det här',
      miksi_auttaa:      'Varför det hjälper',
      mieti_pelissa:     'Tänk på det här i spelet',
      kokeile:           'Prova det här',
      valmentaja_katsoo: 'Din tränare tittar på samma sak.',
      vaihe_leikkija:    'Lekfasen',
      vaihe_rakentaja:   'Byggfasen',
      vaihe_pelipaikka:  'Positionsfasen',
    },
    ...
    vanhempi: {
      kortti_matka_otsikko: 'Spelarens resa',
      huoltaja_otsikko: 'Spelarens vårdnadshavare',
      toast_treeni_kirjattu: 'Träning loggad',
      toast_pallo_ok: ' · boll ✓',
      toast_kehu_lahetetty: 'Beröm skickat!',
      toast_kopioi_pin: 'Kopiera PIN manuellt',
      toast_kirjauduttu_ulos: 'Utloggad',
      toast_valmentaja_reagoi: 'Tränaren {emoji} reagerade',
      toast_kirjasi_treenin: '{nimi} loggade en träning',
      mark_luetuiksi: 'Markera som lästa',
      tulevat_tapahtumat: 'Kommande händelser',
      vinkki_otsikko_u12: 'Tips till föräldrar',
      vinkki_otsikko_u15: 'Kom ihåg',
      vinkki_otsikko_rooli: 'Din roll',
      tek_miten_tukea: 'Så här stöttar du hemma',
      kortti_jaa_otsikko: 'Dela kortet',
      kortti_jaa_nappi: 'DELA',
      aset_yksityisyys: 'Integritet',
      aset_hallitsee_dataa: '{nimi} styr sina data',
      aset_lue_gdpr: 'Läs GDPR-redogörelsen',
      aset_kirjaudu_ulos: 'Logga ut',
      tyyppi_treeni: 'träning',
      tapahtuma_nimeton: 'Händelse',
      hero_tervetuloa_app:    '{nimi} — välkommen till TalentMaster',
  ...
  en: {
    ...
    mittarit: {
      ...
      valmiustila_valmis:   'Ready to train',
      valmiustila_kehittyy: 'Developing',
      valmiustila_huolto:   'Needs care',
      valmiustila_ei_dataa: 'Not measured yet',
    },
    ...
    kortti: {
      ...
      pv:            'd',
      osa_aluetta:   'areas',
      kasvaa:        'Your card grows as you develop.',
      seuraava_taso: 'Next level',
    },

    // Diagram (batch D1)
    kaavio: {
      otsikko: 'What it looks like on the pitch',
      saate:   'Your coach drew this for you.',
      kuittaa: 'I understood this',
      kuitattu: 'Understood',
      kuittaus_epaonnistui: 'The acknowledgement did not go through — try again shortly.',
    },

    // Concept card (phase 4b) — chrome only; card CONTENT has no en source yet (see Pelaaja_v7).
    konseptikortti: {
      eyebrow:           'Me and the ball · current focus',
      milloin_nakyy:     'When you see this',
      miksi_auttaa:      'Why it helps',
      mieti_pelissa:     'Think about this in the game',
      kokeile:           'Try this',
      valmentaja_katsoo: 'Your coach is looking at the same thing.',
      vaihe_leikkija:    'Play phase',
      vaihe_rakentaja:   'Building phase',
      vaihe_pelipaikka:  'Position phase',
    },
    ...
    // V1-B — Vanhempi_v2 (en)
    vanhempi: {
      kortti_matka_otsikko: 'The player\'s journey',
      huoltaja_otsikko: 'Player\'s guardian',
      toast_treeni_kirjattu: 'Session logged',
      toast_pallo_ok: ' · ball ✓',
      toast_kehu_lahetetty: 'Praise sent!',
      toast_kopioi_pin: 'Copy the PIN manually',
      toast_kirjauduttu_ulos: 'Logged out',
      toast_valmentaja_reagoi: 'Coach {emoji} reacted',
      toast_kirjasi_treenin: '{nimi} logged a session',
      mark_luetuiksi: 'Mark as read',
      tulevat_tapahtumat: 'Upcoming events',
      vinkki_otsikko_u12: 'Tip for parents',
      vinkki_otsikko_u15: 'Remember',
      vinkki_otsikko_rooli: 'Your role',
      tek_miten_tukea: 'How to support at home',
      kortti_jaa_otsikko: 'Share the card',
      kortti_jaa_nappi: 'SHARE',
      aset_yksityisyys: 'Privacy',
      aset_hallitsee_dataa: '{nimi} controls their data',
      aset_lue_gdpr: 'Read the GDPR statement',
      aset_kirjaudu_ulos: 'Log out',
      tyyppi_treeni: 'training',
      tapahtuma_nimeton: 'Event',
      hero_tervetuloa_app:    '{nimi} — welcome to TalentMaster',
