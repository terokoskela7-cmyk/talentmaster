...
const TM_LANG = {
  ...
  // ── SUOMI (referenssikieli) ────────────────────────────────────
    ...
    suostumus: {
      ...
      virhe_palvelin:     'Tallennus ei onnistunut eikä suostumusta tallennettu. Yritä hetken päästä uudelleen samasta linkistä. Jos virhe toistuu, ilmoita seuralle (virhekoodi: {koodi}).',
      virhe_lyhyt:        'Tallennus ei onnistunut',
      virhe_yleinen:      'Tallennus epäonnistui: {viesti}',
  ...
  sv: {
    ...
    suostumus: {
      ...
      virhe_palvelin:     'Sparandet misslyckades och samtycket sparades inte. Försök igen om en stund via samma länk. Om felet upprepas, meddela föreningen (felkod: {koodi}).',
      virhe_lyhyt:        'Sparandet misslyckades',
      virhe_yleinen:      'Sparandet misslyckades: {viesti}',
  ...
  en: {
    ...
    suostumus: {
      ...
      virhe_palvelin:     'Saving failed and the consent was not stored. Please try again shortly using the same link. If the error repeats, notify the club (error code: {koodi}).',
      virhe_lyhyt:        'Saving failed',
      virhe_yleinen:      'Saving failed: {viesti}',
