...
var TM_I18N_COMMON = {
  sv: {
    ...
    // Sama teksti molemmissa apeissa (VP + Master): ilmoitusasetusten tallennus kun käyttäjällä
    // ei ole profiilidokumenttia. Ennen tätä sivukirjoitus loi haamuprofiilin (#538/#540).
    'Profiilia ei löytynyt — ota yhteys seuran ylläpitoon.': 'Profilen hittades inte — kontakta föreningens administratör.',
    // Rosterin joukkuejako + pelaajahaku (Sibbo: 50 pelaajaa yhden joukkueen alla).
    // Samat tekstit VP:ssä ja Masterissa → jaettuun karttaan.
    'Hae pelaajaa…': 'Sök spelare…',
    'Valitse joukkue': 'Välj lag',
    ...
    // Uhka-arvo (xT) -kerros editorissa (lib/tm_xt.js + tm_xt_kerros.js)
    'Uhka-arvo (xT)': 'Hotvärde (xT)', 'Pois': 'Av', 'Liikkeiden arvot': 'Rörelsernas värden', 'Uhkakartta': 'Hotkarta',
    'Oma joukkue etenee': 'Eget lag avancerar', 'uhkapistettä': 'hotpoäng', 'syöttöä/kuljetusta': 'passningar/föringar',
    'Lisää syöttö tai kuljetus nähdäksesi uhka-arvon.': 'Lägg till en passning eller föring för att se hotvärdet.',
    'Juoksut avaavat': 'Löpningarna öppnar', 'uhkapistettä, jos pallo tulee perille.': 'hotpoäng om bollen når fram.',
    'Riskikartta': 'Riskkarta',
    'Punainen: pallonmenetys tässä antaa vastustajalle suurimman uhan. Keltainen: oma puolustuskolmannes. Rakentelussa tämä on paikka varmalle ratkaisulle.': 'Rött: bollförlust här ger motståndaren störst hot. Gult: egen försvarstredjedel. I uppbyggnaden är detta platsen för det säkra valet.',
