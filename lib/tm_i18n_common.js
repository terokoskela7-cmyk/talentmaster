...
var TM_I18N_COMMON = {
  sv: {
    ...
    /* — Roolien näyttönimet (enum-roolistringit 'vp'/'valmentaja' EIVÄT tänne).
       HUOM: 'Valmennuspäällikkö' EI commonissa — VP renderöi 'Träningsansvarig' (vakaa), seed ehdotti
       'Utvecklingsansvarig' → jätetty VP-sivukarttaan kunnes roolinimi standardoidaan erikseen. — */
