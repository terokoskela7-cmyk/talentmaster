...
(function (root) {
  ...
  // true = uusi fokus on eri domeenia (fyysinen ↔ teknis_taktinen) kuin aktiivinen → aktiivinen pitää
  // ARKISTOIDA ennen ylikirjoitusta (ei hiljaista klobberia — "Emil-törmäys": fyysinen ja teknis jakso
  // eivät saa hukata toisiaan samasta yhdestä slotista). Sama domeeni = normaali muokkaus (ei arkistoa).
  // Tagittomaton vanha jf tulkitaan 'teknis_taktinen'-domeeniksi (sama fallback kuin sulku/eval §Vaihe7).
