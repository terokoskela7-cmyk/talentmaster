...
(function (root) {
  ...
  function tmHistoriaEntry(o) {
    ...
    return {
      ...
      arvioija_rooli: o.arvioija_rooli || null,   // Vaihe 7 (§4): 'vp'|'valmentaja'|'talenttivalmentaja'|'fysiikkavalmentaja'|'fysioterapeutti' — analytiikkaa varten
      kalibraatio_ero: (o.kalibraatio_ero != null ? o.kalibraatio_ero : null),
      delta_mitattu: o.delta_mitattu || null,
      ohjelma: o.ohjelma || null,   // Vaihe 7 (§2c): kopioi fyysisen jakson ohjelma-objekti → annos–vaste-rivi (AI-analyysin datasetti)
