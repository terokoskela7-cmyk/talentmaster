...
/* Selite = kuvan sisäinen tekstilappu. Validaattori vaatii fi+sv+en, joten kaikki kolme
   täytetään; valmentajan kirjoittama teksti on hänen omaa sisältöään eikä sitä käännetä
   automaattisesti (§32: per-kieli-käännös on myöhempi jalostus, ei keksitty käännös). */
