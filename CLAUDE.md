...
- **CF-runtime TODO (ei-kiireellinen, oma tehtävä ennen syksyä):** Cloud Functions deployattu **Node 20 (1st Gen)** + `firebase-functions` SDK **4.9.0** → nosta **Node 22** + SDK **≥5.1.0** (Node 20 EOL 2026-10-30). `functions/package.json` engines on jo `22`, mutta deploy ajoi 20:n (SDK/CLI vanha) → varmista runtime nousee.
