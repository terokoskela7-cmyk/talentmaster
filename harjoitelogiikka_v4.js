...
const PANKKI = {
  ...
  T: {
    ...
    kaka: {   // OBJEKTIAVAIN 'kaka' säilyy (Vaihe 1 -sauma viittaa siihen) — näyttösisältö = Bellingham
      teema: 'Vastaanottaminen',
      kuvaus_leikkija: 'Bellingham — ensimmäinen kosketus vie pallon menosuuntaan',
      kuvaus_rakentaja: 'Bellingham — 1. kosketus ostaa ajan ja tilan',
      kuvaus_showcase: 'Bellingham — suuntaava vastaanotto paineessa',

      vk1: { // Taso 1: opitaan liike ilman vastustajaa
        nimi: 'Bellingham — Pysäytys sisäterällä',
      ...
      vk2: { // Taso 1+: vastaanotto + suunnanvaihto, nopeus kasvaa
        nimi: 'Bellingham — Vastaanota ja käännä',
      ...
      vk3: { // Taso 2: passiivinen vastustaja — suojaus
        nimi: 'Bellingham — Suojaa ja avaudu',
      ...
      vk4: { // Taso 3: mittaus + oma arvio
        nimi: 'Bellingham — Mittaa ensikosketuksesi',
    ...
    beckham: {
      ...
      vk1: {
        ...
        ohje_showcase: 'Beckham-sarja muodot 1–3: sisäterä | jalkapöytä maassa | suora ilmapassi. 15 × kutakin. Mittaa: osumakohta pallossa (pitää olla keskikohta).',
        kesto: '20 min', xp: 20,
        yt: 'yGHMHi9mMOQ',
        cue: 'Beckham (ManUtd/Real Madrid): tukijalka ratkaisee suunnan. Jalkapöytä ratkaisee nopeuden.',
